...
if(isset($_POST['submit']))
{
	...
	$query="select Email from Accounts where Email=\"$Email\" and Password=\"$Password\"";
	...
	{
		setcookie(Email, $Email, time() + (10*600), "/");
		header("Location:home.php");
	}
}
?>
...
<hr>
<center> <form id="form1" action="login.php#x" name="form1" method="post">
...
<input name="email" type="email" class="input-sm" required> <br>
<br> 
<label for="password" class="label label-primary">Password:</label>
<input name="password" type="password" class="input-sm" id="password" required> <br>
