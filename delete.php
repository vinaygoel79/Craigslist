...
$qu="select Email from Ads where AddId=\"$AddId\" ";
$re=mysql_query($qu);
$ro=mysql_fetch_array($re);
$Em=$ro['Email'];

if($Em==$_COOKIE['Email']||$_COOKIE['Email']=="admin@gmail.com")
	$query="delete from Ads where AddId=\"$AddId\"";
else
...
<div class="container">
  <div class="row">
      ...
      <div class="col-xs-6 col-sm-6 col-md-6 col-lg-5">
        <br><br><p>Ad Successfully Deleted</p><br><br>
<?php
$cookie_name="Email";
echo "
