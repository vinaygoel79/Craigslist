...
<div class="container">
  <div class="row">
      ...
      <div class="col-xs-6 col-sm-6 col-md-6 col-lg-5">
        <br><br><p>Classified Successfully Posted</p><br><br>
        <p><a href="view1.php" class="btn btn-default btn-primary btn-block">View your Ad</a></p>
        <p><a href="postanad.php" class="btn btn-default btn-primary btn-block">Post another Ad</a></p>
      </div>
  </div>
  </div>
<hr>
